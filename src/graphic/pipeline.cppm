...
export namespace graphic::pipeline {
    ...
    std::tuple<vk::raii::ShaderModule, vk::raii::ShaderModule> getShaderModule(
    ...
    vk::raii::RenderPass
    createRenderPass(const vk::raii::Device& device, vk::Format swapChainImageFormat);
...
vk::raii::ShaderModule graphic::pipeline::createShaderModule(
    const vk::raii::Device& device,
...
std::tuple<vk::raii::ShaderModule, vk::raii::ShaderModule> graphic::pipeline::getShaderModule(
    const vk::raii::Device& device
) {
...
vk::raii::PipelineLayout graphic::pipeline::createPipelineLayout(
    const vk::raii::Device& device,
    const vk::raii::DescriptorSetLayout& descriptorSetLayout,
    const vk::raii::ShaderModule& vertShaderModule,
    const vk::raii::ShaderModule& fragShaderModule
...
vk::raii::RenderPass graphic::pipeline::createRenderPass(
    const vk::raii::Device& device,
...
vk::raii::Pipeline graphic::pipeline::createGraphicsPipeline(
    const vk::raii::Device& device,
    const vk::raii::PipelineLayout& pipelineLayout,
    const vk::raii::RenderPass& renderPass,
    const vk::raii::ShaderModule& vertShaderModule,
